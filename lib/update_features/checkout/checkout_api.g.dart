...
class _CheckoutApi implements CheckoutApi {
  ...
  @override
  Future<BaseResponse<OrderModel>> getOrders() async {
  ...
  @override
  Future<BaseResponse<dynamic>> getOrder(CheckoutModel checkoutModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<BaseResponse<CreatedOrderModel>> saveOrder(
    ...
    final _options = _setStreamType<BaseResponse<CreatedOrderModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
